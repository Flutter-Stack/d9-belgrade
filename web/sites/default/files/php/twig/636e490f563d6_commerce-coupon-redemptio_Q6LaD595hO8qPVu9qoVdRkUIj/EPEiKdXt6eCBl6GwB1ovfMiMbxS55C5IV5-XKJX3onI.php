...
class __TwigTemplate_54648b2019a8b9031cb5df66bf6e15fb92cacd19cd22546e6269339aed471837 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
      ...
      <table>
        ";
                ...
                $context['_seq'] = twig_ensure_traversable(twig_array_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "coupons", [], "any", false, false, true, 26), function ($__key__) use ($context, $macros) { $context["key"] = $__key__; return (twig_first($this->env, $context["key"]) != "#"); }));
